...
def run_flatten_print(pipeline, warp_dataset_path, output_path=None, n_samples=3):
    ...
    for image_name in all_image_names:
        ...
        gen_imgs = pipeline.flatten_print(texture_patch, n_samples=n_samples)
...
def get_args():
    ...
    parser.add_argument(
        "--src_dir", default='./data/print_examples', type=str, help="Path to the input image directory"
    )
    parser.add_argument(
        "--save_dir", type=str, default='./outputs/print',  help="Directory to save the output"
    )
    parser.add_argument(
...
if __name__ == "__main__":
    ...
    run_flatten_print(pipeline, src_dir, output_path=save_dir, n_samples=args.n_samples)
